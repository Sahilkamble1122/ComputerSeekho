...
"[project]/app/admin/placement/page.jsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ManagePlacementsPage() {
    ...
    const [filteredStudents, setFilteredStudents] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    const [selectedCourse, setSelectedCourse] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("all");
    const [selectedBatch, setSelectedBatch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("all");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        }).then((res)=>res.json()).then((data)=>setBatches(data));
        // ✅ Fetch all students once
        fetch("http://localhost:8080/api/students", {
            headers: {
                Authorization: `Bearer ${token}`
            }
        }).then((res)=>res.json()).then((data)=>setStudents(data)).catch(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"])({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (searchQuery) {
            filtered = filtered.filter((s)=>s.studentName && s.studentName.toLowerCase().includes(searchQuery.toLowerCase()));
        }
    ...
    const handlePlacementToggle = async (studentId, isPlaced)=>{
        try {
            const token = sessionStorage.getItem("token");
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateStudentPlacementStatus"])(studentId, isPlaced, token);
            // ✅ Local state update so UI updates instantly
            setStudents((prev)=>prev.map((s)=>s.studentId === studentId ? {
                        ...s,
                        isPlaced
                    } : s));
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"])({
...
//# sourceMappingURL=_a648458b._.js.map