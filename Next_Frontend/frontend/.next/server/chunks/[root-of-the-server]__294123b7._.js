...
"[project]/.next-internal/server/app/api/images/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/app/api/images/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const imagesDir = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(process.cwd(), 'public', 'images');
        // Create images directory if it doesn't exist
        try {
            await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["mkdir"])(imagesDir, {
                recursive: true
            });
        } catch (error) {
        ...
        for(let i = 0; i < files.length; i++){
            ...
            const filePath = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"])(imagesDir, fileName);
            try {
...
async function GET(request) {
    try {
        ...
        try {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(filteredImages);
        } catch (fetchError) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__294123b7._.js.map