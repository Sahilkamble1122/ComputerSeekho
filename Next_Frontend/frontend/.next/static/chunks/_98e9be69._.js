...
"[project]/app/admin/gallery/album/[albumId]/page.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AlbumImagesPage() {
    var _images_find;
    _s();
    const { albumId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"])();
    ...
    const fetchImages = async function() {
        ...
        try {
            ...
            const res = await fetch("/api/images?albumId=".concat(albumId), {
                headers: {
                    'Authorization': "Bearer ".concat(token)
                }
            });
            if (!res.ok) {
                ...
                if (res.status === 503) {
                    ...
                    throw new Error(errorData.error || "Failed to fetch images (Status: ".concat(res.status, ")"));
                }
            }
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(err.message || "Failed to fetch images");
        } finally{
            setLoading(false);
            setRefreshing(false);
        }
    ...
    const handleDeleteImage = async (imageId)=>{
        ...
        try {
            const token = sessionStorage.getItem('token');
            const res = await fetch("/api/images/".concat(imageId), {
                method: "DELETE",
                headers: {
                    'Authorization': "Bearer ".concat(token)
                }
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Image deleted");
            fetchImages();
        } catch (err) {
            console.error(err);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(err.message || "Delete failed");
        }
    };
    const handleSetCover = async (imageId)=>{
        try {
            const token = sessionStorage.getItem('token');
            const res = await fetch("/api/images/".concat(imageId, "/cover"), {
                method: "PUT",
                headers: {
                    'Authorization': "Bearer ".concat(token)
                }
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Cover updated");
            fetchImages();
        } catch (err) {
            console.error(err);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(err.message || "Failed to set cover");
        }
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                lineNumber: 135,
                columnNumber: 9
            }, this) : images.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: [
                                            "Cover Image: ",
                                            ((_images_find = images.find((img)=>img.isAlbumCover)) === null || _images_find === void 0 ? void 0 : _images_find.imagePath) || 'None selected'
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/app/admin/gallery/album/[albumId]/page.jsx",
                                        lineNumber: 146,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: images.map((img)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    img.isAlbumCover && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(AlbumImagesPage, "n7Gz2QLenshosFqBbqwMI/xZfKE=", false, function() {
    return [
...
_c = AlbumImagesPage;
var _c;
__turbopack_context__.k.register(_c, "AlbumImagesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_98e9be69._.js.map