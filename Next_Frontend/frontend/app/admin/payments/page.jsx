...
const PaymentsPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Removed debug log: API responses
        ...
        // Removed debug log: processed courses
        ...
        // Removed debug log: processed batches
        ...
        const toUiStudent = (s) => {
          ...
          // Removed debug log of first few students
        ...
        let studentsArr = [];
        // Removed debug logs around studentsData structure
        ...
        // Removed debug log: processed students array

        if (studentsArr.length > 0) {
          // Removed debug log: before sorting
          ...
          // Removed debug log: after sorting
  ...
  // Removed debug log: current state
